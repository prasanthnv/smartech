...
public class AlarmRingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarm_id = alarm_intent.getStringExtra("id");
        Log.e("FROM RECIVER => ", "");
        ...
        if (alarmCursor.moveToFirst()) {
            do {
                times = Integer.parseInt(alarmCursor.getString(alarmCursor.getColumnIndex("times")));
                difficulty = Integer.parseInt(alarmCursor.getString(alarmCursor.getColumnIndex("difficulty")));
                Log.e("Times", "" + times);
    ...
    public void askQuestions() {
        ...
        if (times != 0) {
            ...
            stopSound();
            dbHandler.deleteAlarm(sqLiteDatabase, alarm_id);
            finish();
        }
    }
